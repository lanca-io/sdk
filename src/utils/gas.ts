 ...
 */
export const getGasFees = async (client: Client): Promise<{ maxFeePerGas: bigint | undefined, maxPriorityFeePerGas: bigint | undefined }> => {
    ...
    const maxPriorityFeePerGas = maxPriorityFeePerGasMedian > maxPriorityFeePerGasAvg
